...
export enum PushedDataDescription {
  ...
  TAPROOTOUTPUT = "This is the 32-bytes | 64 characters output public key used when sending Bitcoin to a TapRoot address - this means there is both a key path & script path in this output.",
...
export const previousTransactionURL =
...
export const coinbaseDescription =
...
export const coinbaseDataDescription =
...
// Push OP
export const pushOPDescription =

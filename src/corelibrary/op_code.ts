...
export abstract class OP_Code {
  ...
  class OP_RIPEMD160 extends OP_Code {
    constructor() {
      super("OP_RIPEMD160", 166, "0xa6", "Input is hashed using the RIPEMD-160 hashing algorithm.");
    }
  ...
  class OP_SHA1 extends OP_Code {
    constructor() {
      super("OP_SHA1", 167, "0xa7", "Input is hashed using the SHA1 hashing algorithm.");
    }
  ...
  class OP_SHA256 extends OP_Code {
    constructor() {
      super("OP_SHA256", 168, "0xa8", "Input is hashed using the SHA256 hashing algorithm.");
    }
  ...
  class OP_HASH160 extends OP_Code {
    constructor() {
      super("OP_HASH160", 169, "0xa9", "Input is hashed twice. First with SHA256 then with RIPEMD-160.");
    }

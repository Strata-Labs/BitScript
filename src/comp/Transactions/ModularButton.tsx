...
const ModularButton = () => {
  ...
  if (inputIsRawHex) {
    // If inputIsRawHex is true, show content for Raw Hex
    if (inputIsRawHexAndState === "1") {
      // Render content for inputIsRawHexAndState "1"
      buttonContent = (
        <>
    ...
    } else if (inputIsRawHexAndState === "2") {
      // Render content for inputIsRawHexAndState "2"
      buttonContent = (
        <>
          <div className="mt-2 flex h-[26.5px] w-[160px] flex-row items-center justify-start rounded-full bg-[#F0F0F0] p-4 md:mt-0 md:h-[53px] md:w-[218px]">
    ...
    } else if (inputIsRawHexAndState === "3") {
      // Render content for inputIsRawHexAndState "3"
      buttonContent = (
        <>
    ...
    // If inputIsTxId is true, show content for TxId
    if (inputIsTxIdAndState === "1") {
      // Render content for inputIsTxIdAndState "1"
      buttonContent = (
        <>
          <>
    ...
    } else if (inputIsTxIdAndState === "2") {
      // Render content for inputIsTxIdAndState "2"
      buttonContent = (
        <>
    ...
    } else if (inputIsTxIdAndState === "3") {
      // Render content for inputIsTxIdAndState "3"
      buttonContent = (
        <>
    ...
    // Default content when neither inputIsRawHex nor inputIsTxId is true
    buttonContent = (
      <>
        <button

...
const SaveScript = (props: SaveScriptProps) => {
  ...
  const isMyScript = sandboxScript !== undefined && payment?.userId === sandboxScript.userId

  const [title, setTitle] = useState<string>(sandboxScript?.name || '')
  const [description, setDescription] = useState<string>(sandboxScript?.description || '')
          ...
          >
            <div className="relative z-50 flex w-full flex-col items-center justify-center">
              ...
              <div className="w-full h-full py-4">
                ...
                <input
                  type="text"
                  className="text-md bg-[#0c071D] my-4 flex h-[50px] w-full rounded-full border-b border-white border-opacity-10 pl-8 pr-4 text-white focus:outline-none"
                ...
                <textarea
                  ...
                  id="comment"
                  className="text-md bg-[#0c071D] my-4 flex w-full rounded-[40px] border-b border-white border-opacity-10 pl-8 pr-4 text-white focus:outline-none"
              ...
              <button
                type="submit"
                className="mt-6 flex w-full  flex-col items-center justify-center rounded-lg transition-all cursor-pointer bg-dark-orange shadow-md hover:shadow-lg"

      ...
      <div className="mt-5 w-full">
        ...
        <div className=" -mt-[120px] ml-5 mr-5 flex flex-row justify-start">
          <div className="mr-10 flex w-full flex-col">
            <p className="text-[12px] font-semibold text-black md:text-[16px]">
            ...
            >
              <div className="flex flex-row items-center">
                ...
                <p className="ml-2 text-[8px] font-semibold text-black md:text-[16px]">
                  OP Codes
                </p>
              </div>
            ...
            >
              <div className="flex flex-row items-center">
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 fill-[#6C5E70] group-hover:fill-[#F79327]"
                >
                ...
                <p className="text-[8px] font-semibold text-black md:text-[16px]">
                  Common Scripts
                </p>
              </div>

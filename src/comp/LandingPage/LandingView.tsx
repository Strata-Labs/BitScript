...
const LandingView = () => {
  return (
    <div className="flex flex-col bg-[#F8F8F8] w-screen h-screen items-center overflow-auto">
      <div className="min-h-[213px] w-[353px] bg-[#0C071D] rounded-2xl mt-[100px] flex flex-col items-center justify-center">
        <p className='gradient-text text-[31px] ml-5 mr-5 text-center font-semibold'> Learn & Write Bitcoin</p>
        <button className='flex w-[221px] h-[44px] bg-white rounded-lg mt-5 items-center justify-center'>

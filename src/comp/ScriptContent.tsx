...
<div className="h-screen overflow-auto w-screen">
    ...
    <div className='flex flex-col justify-center items-center md:justify-start md:flex-row md:flex-wrap md:ml-[265px] mt-6 mr-5 ml-4'>
        <div className='flex'>
            ...
            <div className="bg-[#0C071D] bg-opacity-10 h-[31px] w-[228px] ml-7 md:ml-9 xl:ml-3 rounded-full -mt-1 items-center justify-center flex">
        ...
        <div className='flex md:mt-4 mt-4 xl:mt-1 xl:ml-4'>
            ...
            <div className="bg-[#0C071D] bg-opacity-10 h-[31px] w-[228px] ml-3 md:ml-5 xl:ml-3 rounded-full -mt-1 items-center justify-center flex">
                <p className='text-black text-[12px]'>304502203f004eeed0cef2fd...</p>
            </div>
        </div>
    </div>

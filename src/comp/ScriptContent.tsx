...
<div className="h-screen overflow-auto w-screen">
    <div className='w-screen flex justify-between md:mt-5 mt-[100px]'>
        <div className='flex justify-start md:ml-[260px]'>
            ...
            >
                ...
                className="transform rotate-180 md:mt-0 mt-3 md:ml-0 ml-2"
                >
    ...
    <div className='flex flex-col items-start ml-4 mr-4 md:ml-[265px] md:mr-[200px] mt-7'>
        <p className='text-[#6C5E70] text-[16px] font-extralight'>A Pay-to-Public-Key-Hash (P2PKH) script is a common type of Bitcoin transaction script that allows bitcoins to be sent to a specific Bitcoin address. The script locks the bitcoins to the hash of a public key, requiring a signature from the corresponding private key to spend them. When the bitcoins are spent, the spender provides a scriptSig that includes the public key and a valid signature.</p>
        <p className='text-black font-semibold mt-[60px] text-[18px]'>OP_Code(s) Review</p>
        <p className='text-[#6C5E70] text-[16px] font-extralight mt-[20px]'>P2PKH requires three (3) pieces of data & four (4) op_codes. The three (3) editable data items required are seen below. </p>
    </div>
    <div className='flex flex-col justify-center items-center md:justify-start md:flex-row md:flex-wrap md:ml-[265px] mt-6 mr-5 ml-4'>
        <div className='flex'>
            ...
            <p className='text-black ml-3 md:ml-5'>Signature</p>
            <div className="bg-[#0C071D] bg-opacity-10 h-[31px] w-[228px] ml-7 md:ml-9 lg:ml-3 rounded-full -mt-1 items-center justify-center flex">
        ...
        <div className='flex md:mt-4 mt-4 lg:mt-1 lg:ml-4'>
            ...
            <p className='text-black ml-3 md:ml-4'>Public Key</p>
            <div className="bg-[#0C071D] bg-opacity-10 h-[31px] w-[228px] ml-6 md:ml-8 lg:ml-3 rounded-full -mt-1 items-center justify-center flex">
                <p className='text-black text-[12px]'>304502203f004eeed0cef2fd...</p>
            </div>
        </div>
        <div className='flex md:mt-4 mt-4 lg:mt-1 lg:ml-4'>
            ...
            <p className='text-black ml-3 md:ml-4'>Hashed Key</p>
            <div className="bg-[#0C071D] bg-opacity-10 h-[31px] w-[228px] ml-3 md:ml-5 lg:ml-3 rounded-full -mt-1 items-center justify-center flex">
                <p className='text-black text-[12px]'>304502203f004eeed0cef2fd...</p>
            </div>
        </div>
    </div>

...
const ScriptContent: React.FC = () => {
  return (
    <div className="h-screen w-screen overflow-auto">
      ...
      <div className="mt-6 flex flex-col items-center justify-center md:ml-[265px] md:flex-row md:flex-wrap md:justify-start">
        <div className="flex">
          <div className="flex">
            <svg
              width="16"
          ...
          <div className="-mt-1 ml-12 flex h-[31px] w-[228px] items-center justify-center rounded-full bg-[#0C071D] bg-opacity-10 md:ml-9 xl:ml-3">
            <p className="text-[12px] text-black">
              304502203f004eeed0cef2fd...
            </p>
          </div>
        </div>
        <div className="mt-4 flex md:mt-4 lg:ml-4 lg:mt-1">
          <svg
            width="21"
            height="21"
            viewBox="0 0 21 21"
          ...
          <p className="ml-5 text-black md:ml-4">Public Key</p>
          <div className="-mt-1 ml-11 flex h-[31px] w-[228px] items-center justify-center rounded-full bg-[#0C071D] bg-opacity-10 md:ml-8 lg:ml-3">
            <p className="text-[12px] text-black">
              304502203f004eeed0cef2fd...
            </p>
          </div>
        </div>
        <div className="mt-4 flex md:mt-4 xl:ml-4 xl:mt-1">
          <svg
            width="21"
            height="21"
            viewBox="0 0 21 21"
          ...
          <p className="ml-5 text-black md:ml-4">Hashed Key</p>
          <div className="-mt-1 ml-8 flex h-[31px] w-[228px] items-center justify-center rounded-full bg-[#0C071D] bg-opacity-10 md:ml-5 xl:ml-3">
            <p className="text-[12px] text-black">
              304502203f004eeed0cef2fd...
            </p>
          </div>

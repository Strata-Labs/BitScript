...
const BottomVideoContainer: React.FC = () => {
  return (
    <div className="flex-col items-center justify-center md:items-start">
      <div className="mb-5 ml-12 mr-12 mt-4 flex h-[614px] flex-col items-center rounded-xl bg-white md:ml-[267px] md:mr-8 md:h-[420px] md:min-w-[1200px] md:items-start md:justify-between lg:pb-4">
        ...
        <div className="mt-4 flex flex-col md:justify-between">
          <div className="mt-4 flex flex-col md:flex-row md:justify-between">
            <div className="flex h-[200px] w-[350px] flex-col rounded-xl bg-[#26292C] md:ml-7 md:mt-0 md:h-[303px] md:w-[494px] ">
              <div className="flex h-[35px] w-[350px] items-start rounded-t-lg bg-[#1C1E20] md:w-[494px]">
                {/* 3 buttons */}
            ...
            <div className="flex flex-col md:ml-10 md:mr-5">
              ...
              {/* Video */}
              <div className="mt-5 flex h-[200px] w-[350px] rounded-lg bg-[#F9F9F9] md:h-[260px] md:min-w-[594px] md:items-center"></div>
            </div>
          </div>

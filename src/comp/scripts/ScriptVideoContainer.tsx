    ...
    <div className="flex-col items-center justify-center bg-purple-200 md:items-start">
      ...
      <div className="mx-12 mb-5 mt-4 flex h-[614px] flex-col items-center rounded-xl bg-white md:ml-[267px] md:mr-8 md:h-[420px] md:min-w-[1200px] md:items-start md:justify-between lg:pb-4">
        ...
        <div className="mt-4 flex w-full flex-col md:justify-between">
            ...
            <div className="flex w-full">
              <div className="mx-10 flex h-[200px] w-full flex-col rounded-xl bg-[#26292C] md:mx-0 md:mx-0 md:ml-7 md:mt-0 md:h-[303px] md:w-[494px] ">
                ...
                <div className="ml-3 mt-1 flex flex-col">
                  <p className="text-[11px] text-[#787878] md:text-[16px]">
                    # UnlockScript/ScriptSig
                  </p>
                  <p className="text-[11px] md:text-[16px]">[signature]</p>
                  <p className="text-[11px] md:text-[16px]">[public-key]</p>
                  <p className="mt-2 text-[11px] text-[#787878] md:text-[16px]">
                    # LockScript/ScriptPubKey
                  </p>
                  <p className="text-[11px] md:text-[16px]">&lt;dup&gt;</p>
                  <p className="text-[11px] md:text-[16px]">&lt;hash160&gt;</p>
                  <p className="text-[11px] md:text-[16px]">
                    [hash160[publick-key]]
                  </p>
                  <p className="ml-1 text-[11px] md:text-[16px]">
                    &lt;equalverify&gt;
                  </p>
          ...
          <div className="ml-7 mt-4 hidden h-[50px] w-[1130px] items-center justify-start rounded-xl bg-[#F9F9F9] md:flex">
            {/* Fast Rewind */}

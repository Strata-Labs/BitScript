...
const ContentContainer: React.FC = () => {
  return (
    <div className="h-screen overflow-auto w-screen">
      ...
      <div className="hidden md:block bg-white w-screen items-center justify-between p-5 h-[90px]">
        <input
          type="text"
        ...
        <div className='flex flex-wrap'>
          <p className="mt-6 md:mt-6 ml-9 md:ml-[270px] text-[20px] text-[#0C071D] font-semibold">Select A Bitcoin Script</p>
          <p className="md:mt-6 ml-1 text-[20px] text-[#0C071D] font-semibold md:block hidden">Format To Explore</p>
            <button className="bg-trasparent border border-[#6C5E70] border-opacity-50 group hover:border-opacity-100 rounded-lg w-[24px] h-[24px] lg:w-[38px] lg:h-[38px] justify-center items-center ml-2 absolute right-0 mr-20 lg:mr-24 lg:mt-6 -mt-6 hidden md:flex">
              <svg
            ...
            <button className="bg-trasparent border border-[#6C5E70] border-opacity-50 group hover:border-opacity-100 rounded-lg w-[24px] h-[24px] lg:w-[38px] lg:h-[38px] justify-center items-center ml-2 absolute right-0 mr-12 lg:mt-6 -mt-6 hidden md:flex">
              <svg
                className="text-[#6C5E70] opacity-50 group-hover:opacity-100 md:w-[14px] md:h-[14px] lg:w-[20px] lg:h-[20px]"
                xmlns="http://www.w3.org/2000/svg"
                width="20"

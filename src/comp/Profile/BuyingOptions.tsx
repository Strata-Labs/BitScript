            ...
            >
              <div className="relative z-10 ml-[20px] mr-[20px] flex flex-col items-start justify-center ">
                    ...
                    {whichButton !== "USD" ? (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            setWhatFrequency(PaymentLength.ONE_YEAR)
                          }
                        >
                          <p className="text-[10px] font-extralight lg:text-[16px]">
                            Annual
                        ...
                        <button
                          ...
                          onClick={() =>
                            setWhatFrequency(PaymentLength.LIFETIME)
                          }
                        >
                          <p className="text-[10px] font-extralight lg:text-[16px]">
                            Flat Fee
                      ...
                      <div className="flex flex-row rounded-full bg-[#F3F3F3] p-1">
                        <button
                          ...
                          onClick={() =>
                            setWhatFrequency(PaymentLength.ONE_MONTH)
                          }
                        >
                          <p className=" text-[10px] font-extralight lg:text-[16px]">
                            Monthly
                ...
                <div className="mt-3 flex flex-col">
                  ...
                  <p>
                    Reach out at jesus@stratalabs.xyz for better pricing as
                    we’re always looking to work more closely with teams in the
                    space.
                  </p>
                </div>
              </div>

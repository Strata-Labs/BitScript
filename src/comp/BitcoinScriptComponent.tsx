...
const BitcoinScriptComponent = () => {
  return (
    <div className="w-[253px] h-[123px] bg-[#F4F4F4] flex flex-col items-center justify-center mt-6 rounded-lg relative group-hover:bg-[#321B3A]">
      ...
      {/* Dotted Line */}
      <div className="border-dashed border-[.3px] border-[#6C5E70] w-[130px] md:group-hover:border-white"></div>
      {/* Arrow */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[10px] h-[10px] -rotate-45 rounded-sm border-b-[5px] border-r-[5px] border-[#6C5E70] md:group-hover:border-white"></div>
    </div>
  );
};

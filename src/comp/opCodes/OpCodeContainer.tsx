  ...
  return (
    <Link href={linkPath} target="_blank">
      <div className="flex w-screen justify-center md:w-full">
        ...
        <div
          className="group mx-[80px] flex min-h-[200px] w-full flex-col justify-between rounded-xl bg-white from-[#100F20] to-[#321B3A] p-4 px-5 transition-all duration-500 ease-in-out hover:-translate-y-1 hover:bg-gradient-to-b md:min-h-[200px] md:w-[274px] md:rounded-xl"
        ...
        >
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
            ...
            <div className="flex h-[27px] min-w-[80px] items-center justify-center rounded-full bg-[#F4F4F4] px-4 transition-all duration-500 ease-in-out group-hover:bg-[#3E314A] ">
              <p className="whitespace-nowrap text-[12px] font-extralight text-[#6C5E70] transition-all duration-500 ease-in-out group-hover:text-[#FFFFFF]">
                {category}
              </p>
            </div>

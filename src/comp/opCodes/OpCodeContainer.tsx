  ...
  return (
    <Link href={linkPath}>
      <div className="mb-5 flex justify-center">
        ...
        <div className="group mx-9 flex h-[345px] w-[353px] flex-col justify-between rounded-lg bg-white from-[#100F20] to-[#321B3A] p-4 px-5 transition-all duration-500 ease-in-out hover:-translate-y-1 hover:bg-gradient-to-b md:h-[345px] md:w-[274px] md:rounded-xl">
          <div className="flex flex-col items-center">
            ...
            {/* Summary */}
            <p className="mt-1 text-center text-[14px] font-light text-[#111827] transition-all duration-500 ease-in-out group-hover:text-white md:mt-5">
              {summary}
            </p>
          </div>

  ...
  return (
    <div className="flex w-full flex-col items-center justify-center md:items-start">
      <div className="flex w-full">
        <div className="mx-12 mt-4 flex min-h-[614px] w-full flex-col items-center rounded-xl bg-white md:ml-[267px] md:mr-8 md:min-h-[405px] md:min-w-[1156px]  md:flex-row md:items-center lg:pb-4 2xl:justify-between">
          <div className="flex w-full">
            <div className="mx-5 mt-8 flex w-full flex-col ">
              ...
              <p className="mt-5 w-full text-[16px] text-[#26292C]">
                {description}
              </p>
              ...
              <div className="flex w-full flex-col items-center justify-center">
                ...
                <div className="flex w-full flex-col items-center justify-center">
                  <div className="mx-10 mt-5 flex h-[195px] w-full rounded-lg bg-[#F9F9F9] md:hidden">
                    {windowWidth < 600 && (
                      <svg
                        ref={svgRef}
          ...
          <div className="mx-10 mt-8 flex md:flex-col">
            {windowWidth > 600 && (
              <svg
                ref={svgRef}
                id={SATOSHI_ART_BOARD}
...
export const StackTextSteps = ({
  ...
  return (
    <div className="mr-5 mt-5 flex flex-row items-center md:mt-10">
      {/* 1 */}
      <button

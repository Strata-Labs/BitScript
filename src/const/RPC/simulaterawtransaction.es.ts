...
export const simulaterawtransactionEs: RPCFunctionParams = {
  ...
  category: "Cartera",
  summary:
    "Calcula el efecto de una transacción cruda sobre el saldo de la cartera, sin difundirla.",
  description:
    "Simula el impacto de una transacción sin enviarla a la red.",
  howIsThisUsed:
    "Sirve para prever el efecto de firmar y difundir transacciones crudas sobre el saldo de la cartera.",
  inputs: [
    {
      ...English.inputs[0],

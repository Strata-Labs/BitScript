...
export const listsinceblockEs: RPCFunctionParams = {
  ...
  description:
    "Devuelve todas las transacciones de la cartera ocurridas desde el block hash especificado.",
  howIsThisUsed:
    "El comando listsinceblock sirve para recuperar el historial de transacciones desde un bloque dado, lo que ayuda a hacer seguimiento de la actividad de la cartera y a confirmar el estado de las transacciones. Resulta especialmente útil para supervisar las transacciones entrantes y salientes, sobre todo en escenarios en los que una reorganización pueda afectar al historial.",
  inputs: [
    {
      ...English.inputs[0],

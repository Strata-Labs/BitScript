...
export const keypoolrefillEs: RPCFunctionParams = {
  ...
  category: "Cartera",
  summary:
    "Rellena el keypool de la cartera para direcciones futuras.",
  description:
    "Reabastece el keypool, útil tras importar claves o cambiar la configuración.",
  howIsThisUsed:
    "Este comando se utiliza habitualmente para mantener una reserva de claves sin usar en la cartera. Cuando se genera una nueva dirección o se firma una transacción, se consume una clave del keypool. Reabastecerlo garantiza que la cartera disponga en todo momento de suficientes claves, lo que mejora la eficiencia y evita problemas de agotamiento de claves.",
  inputs: [
    {
      ...English.inputs[0],

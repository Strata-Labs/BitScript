...
const InvertSteps: EXECUTION_STEPS[] = [
  // Video 1
  {
    containers: [0],
    mainStack: [],
...
export const OP_INVERT: OP_CODE_PAGE_PROPS = {
  name: "OP_INVERT",
  opCode: "131",
  hex: "0x83",
  category: "Arithmetic",
  ...
  linkPath: "/OPS/OP_INVERT",
  tileImage: SHA1,
  type: "Pop & Push",
  generalType: "OpCode",
  visualProps: {
    stackSteps: InvertSteps,
    failureSteps: InvertSteps,
    title: "OP_Code Walkthrough",
    description: "Performs a bitwise inversion on the top item of the stack.",
    steps: [

...
export const OP_FROMALTSTACK_STEPS: EXECUTION_STEPS[] = [
  {
    // First Video
    containers: [0],
    mainStack: [],
    ...
    actions: [
      {
        ...
        data: {
          ...
          hex: "0x76",
          stackIndex: 0,
          description: "Remvoes the top item from the alternate stack and pushes it to the main stack",
...
export const OP_FROMALTSTACK: OP_CODE_PAGE_PROPS = {
  ...
  seenIn: "N/A",
  status: "Committed",
  linkPath: "/OPS/OP_FROMALTSTACK",
  tileImage: TileImage,
  type: "Pop & Push",
  generalType: "OpCode",
  longName: "",
  visualProps: {
    stackSteps: OP_FROMALTSTACK_STEPS,
    title: "OP_Code Walkthrough",
    failureSteps: OP_FROMALTSTACK_STEPS,
    description:
      "Moves the top item from the alternate stack to the main stack.",
    steps: [

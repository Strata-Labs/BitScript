...
const OP_2MUL_STEPS: EXECUTION_STEPS[] = [
  // Video 1
  {
    containers: [0],
    mainStack: [],
...
export const OP_2MUL: OP_CODE_PAGE_PROPS = {
  name: "OP_2MUL",
  opCode: "141",
  hex: "0x8d",
  category: "Arithmetic",
  shortDescription: "Multiplies the top item on the stack by 2.",
  longDescription:
  ...
  linkPath: "/OPS/OP_2MUL",
  tileImage: SHA1,
  type: "Pop & Push",
  generalType: "OpCode",
  visualProps: {
    stackSteps: OP_2MUL_STEPS,
    failureSteps: OP_2MUL_STEPS,
    title: "OP_Code Walkthrough",
    description: "Multiplies the top item on the stack by 2.",
    steps: [
